...
(function() {
  var Stream, coffee, coffee_helpers, compile, conf, convert, errx, fs, is_literate, optparse, parse_opts, path;
  ...
  compile = function(file) {
    var comment, compiled, e, inColor, src;
    try {
    ...
    if (conf.maps) {
      comment = convert.fromJSON(compiled.v3SourceMap).setProperty('sources', [file]).toComment();
      return "" + compiled.js + "\n" + comment;
    } else {
